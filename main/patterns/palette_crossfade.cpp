...
namespace palette_crossfade_ns {
...
using namespace palette_crossfade_ns;
 
void PaletteCrossfade::loop() {
...
void PaletteCrossfade::FillLEDsFromPaletteColors(uint8_t colorIndex) {
...
void PaletteCrossfade::ChangePalettePeriodically() {
