...
using namespace two_sin_pal_ns;

void TwoSinPal::setup() {
...
void TwoSinPal::resetvars() {                       // Reset the variable back to the beginning.
